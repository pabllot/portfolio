          ...
          <TextBox>
            ...
            <Paragraph>{`${
              english
                ...
                : "Meu nome é Pablo Teixeira, tenho 25 anos. Sou um desenvolvedor frontend e maratonador de série nas horas vagas. Um profissional dedicado, determinado a sempre atingir os objetivos propostos e ajudar sua equipe."
            }`}</Paragraph>
          </TextBox>
        </Wrapper>
      </SubContainer>
